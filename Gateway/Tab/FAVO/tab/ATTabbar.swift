...
@objc(ATTabbar) class ATTabbar: UIStoryboardSegue {
    ...
    override func perform() {
        let tabBarViewController:ViewController = self.source as! ViewController
        ...
        {
            tabBarViewController.oldViewController!.willMove(toParentViewController: nil)
        ...
        myDestinationviewController.didMove(toParentViewController: tabBarViewController)
    }
}
